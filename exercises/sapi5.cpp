...
int main() {
    ...
    ISpObjectWithToken* objectWithToken = NULL;
    recognizer->QueryInterface(IID_ISpObjectWithToken, (void**)&objectWithToken);
    objectWithToken->SetToken(NULL);
    objectWithToken->SetRecognizerLocale(L"en-US");
    objectWithToken->Release();
